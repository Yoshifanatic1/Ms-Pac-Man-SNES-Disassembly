; Note: Put your custom routine/data macros, references to them, and defines in this file from within the MSPM_InsertIntegratedPatches and MSPM_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro MSPM_InsertIntegratedPatches()
...
macro MSPM_ApplyPatchesPostAssembly()
